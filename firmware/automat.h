...
#define MAT_PIR_SPOT_PIN 	PINC
#define MAT_PIR_SPOT_PORT	PORTC
#define MAT_PIR_SPOT		PC1

#define MAT_PIR_ROOM_PIN 	PINC
#define MAT_PIR_ROOM_PORT	PORTC
#define MAT_PIR_ROOM		PC2
